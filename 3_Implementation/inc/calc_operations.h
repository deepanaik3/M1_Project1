 ...
 * @author Deepa R Naik (dpanaik2000@gmail.com)
...
#ifndef _CALC_OPERATIONS_H_
#define _CALC_OPERATIONS_H_
 ...
 * 
 */
int cotx(int operand1)
#endif /* #define _SCIENTIFIC_CALCULATOR_H_ */